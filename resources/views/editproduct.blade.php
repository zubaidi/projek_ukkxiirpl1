...
<main class="py-4 px-md-4 ml-sm-auto col-lg-10">
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('update.product', $barang->kode_barang) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="kode_barang" class="form-label">Kode Barang</label>
                    <input type="text" class="form-control" id="kode_barang" name="kode_barang" value="{{ old('kode_barang', $barang->kode_barang) }}" disabled>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="harga_barang" name="harga_barang" value="{{ old('harga_barang', $barang->harga_barang) }}" min="0" required>
                </div>
